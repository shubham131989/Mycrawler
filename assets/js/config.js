    ...
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider',
        ...
        function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
            ...
            $stateProvider
                ...
                .state('app.crawlData', {
                    url: "/crawlData",
                    templateUrl: "tpl/crawlData.html",
                    controller: 'crawlDataCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                    'nvd3',
                                ...
                                .then(function() {
                                    return $ocLazyLoad.load([
                                        'assets/js/controllers/crawlDataUiController.js'
                                    ]);
                                });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function() {
                                    return $ocLazyLoad.load([
                                        'assets/js/controllers/archivesUiController.js'
                                    ]);
                                });
                        }]
                    }
            ...
            .state('app.mypage', {
                url: '/mypage',
                templateUrl: 'tpl/mypage.html', // your tpl location
                controller: 'MyPageCtrl', // controller name defined in mypage.js
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([
                                // any 3rd part plugins you want to load. 
                                // Refer to config.lazyload.js to see the full list
                            ], {
                                insertBefore: '#lazyload_placeholder'
                            })
                            .then(function() {
                                return $ocLazyLoad.load('assets/js/controllers/mypage.js'); // set controller location
                            });
                    }]
                }
            })
