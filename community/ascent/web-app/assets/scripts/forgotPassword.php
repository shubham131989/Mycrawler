...
$userQuery = $conn->query("SELECT * FROM user WHERE emailId = '$emailId'");
    ...
    $to = $emailId;
    $subject = "OTP for your email from Sell Sahi POS";
    
    $message = '
    <html>
    <head>
    <title>Welcome to POS | Your invoice management solution</title>
    </head>
    <body>
 <div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%;min-width:100%" width="100%">
                    <tbody><tr>
                        ...
                        <td valign="top" style="padding-top:0;padding-right:18px;padding-bottom:9px;padding-left:18px">
                            ...
                            <span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif">Sell Sahi PoS | Crafted with <span style="color:#800080">❤</span> in India</span>
                        </td>
                    </tr>
                </tbody></table>
