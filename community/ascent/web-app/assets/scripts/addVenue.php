...
$conn->query("INSERT INTO `venue`(`catererId`, `venueName`, `contactNo`, `emailId`, `website`, `line1`, `line2`, `placeId`, `latitude`, `longitude`, `zipcodeId`) 
    VALUES ('$catererId', '$venueName', '$contactNo', '$emailId', '$website', '$line1', '$line2', '$placeId', '$latitude', '$longitude', '$zipcodeId')");
if(mysqli_error($conn)){
    $flag = 0;
} else {
    $response['venueId'] = mysqli_insert_id($conn);
}
