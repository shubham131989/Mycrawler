...
$pan = $_POST['company']['pan'];
$gstin = $_POST['company']['gstin'];
$email = $_POST['company']['emailId'];
$contactNo = $_POST['company']['contactNo'];
$website = $_POST['company']['website'];
$description = $_POSTS['company']['description'];
...
if($query->num_rows > 0){
	...
	if(mysqli_error($conn)){
	    ...
	    $conn->query("INSERT INTO `company`(`userId`, `companyName`, `contactNo`, `emailId`, `website`, `pan`, `gstin`, `description`, `isActive`)
	    VALUES ('$userId', '$companyName', '$contactNo', '$emailId', '$website', '$pan', '$gstin', '$description', '1')");
	    $companyId = mysqli_insert_id($conn);
	    
	    $conn->query("INSERT INTO `companyAddress`(`companyId`, `line1`, `line2`, `placeId`, `latitude`, `longitude`, `zipcodeId`)
	    VALUES ('$companyId', '$line1', '$line2', '$placeId', '$latitude', '$longitude', '$zipcodeId')");
