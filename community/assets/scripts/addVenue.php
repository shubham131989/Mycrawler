...
$conn->query("INSERT INTO `venue`(`companyId`, `venueName`, `contactNo`, `emailId`, `website`, `line1`, `line2`, `placeId`, `latitude`, `longitude`, `zipcodeId`) 
    VALUES ('$companyId', '$venueName', '$contactNo', '$emailId', '$website', '$line1', '$line2', '$placeId', '$latitude', '$longitude', '$zipcodeId')");
